...
alias mk='make -f /c/github.com/dennisbot/cp/Makefile FILE=$(ls --color=never -t *.cpp | fzf --height ~60 --reverse --select-1)'
alias mkc='make -f /c/github.com/dennisbot/cp/Makefile clean'
