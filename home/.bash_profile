...
if [[ -n $RUNNING_IN_MSYS2 ]]; then
  export PATH="$PATH:/c/ProgramData/chocolatey/bin:/c/Program Files/Sublime Text:/c/Program Files/Sublime Merge:/c/Program Files/Git/bin:/c/Program Files/Microsoft VS Code/bin"
  # Running in MSYS2
